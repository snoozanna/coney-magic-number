...
function App2() {
  ...
  useEffect(() => {
    setResponse3(
      (prev) => checkbox.box1 + "," + checkbox.box2 + "," + checkbox.box3,
    );
  }, [checkbox]);
        ...
        <div id="surv" className={page2} hidden>
          ...
          <div className="radio_option">
            <input
              type="radio"
              value="22"
              onClick={(event) => setResponse2(question2.a)}
              name="r"
              className="radio"
            />
            ...
            <input
              ...
              name="r"
              className="radio"
              onClick={(event) => setResponse2(question2.b)}
            />
            ...
            <input
              ...
              name="r"
              className="radio"
              onClick={(event) => setResponse2(question2.c)}
            />
        ...
        <div id="surv" className={page3} hidden>
          ...
          <div className="radio_option">
            <input
              ...
              name="e"
              className="checkbox"
              onClick={(event) => updateBox("1", question3.a)}
            />
            ...
            <input
              type="checkbox"
              onClick={(event) => updateBox("2", question3.b)}
              value="22"
              name="e"
              className="checkbox"
            />
            ...
            <input
              type="checkbox"
              onClick={(event) => updateBox("3", question3.c)}
              value="."
              name="r"
              className="checkbox"
            />
